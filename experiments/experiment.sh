...
python train.py --exp-name ${label} --save-dir policies/${label}/policy $*
...
python sheldon.py --exp-name ${label}_sheldon12_landmark01 --num-sheldons 2 --sheldon-ids 1 2 --sheldon-targets 0 1  --load-dir policies/${label}/policy --restore --benchmark --save-replay --deterministic $*
python sheldon.py --exp-name ${label}_sheldon02_landmark12 --num-sheldons 2 --sheldon-ids 0 2 --sheldon-targets 1 2  --load-dir policies/${label}/policy --restore --benchmark --save-replay --deterministic $*
python sheldon.py --exp-name ${label}_sheldon02_landmark02 --num-sheldons 2 --sheldon-ids 0 2 --sheldon-targets 0 2  --load-dir policies/${label}/policy --restore --benchmark --save-replay --deterministic $*
python sheldon.py --exp-name ${label}_sheldon02_landmark01 --num-sheldons 2 --sheldon-ids 0 2 --sheldon-targets 0 1  --load-dir policies/${label}/policy --restore --benchmark --save-replay --deterministic $*
python sheldon.py --exp-name ${label}_sheldon01_landmark12 --num-sheldons 2 --sheldon-ids 0 1 --sheldon-targets 1 2  --load-dir policies/${label}/policy --restore --benchmark --save-replay --deterministic $*
python sheldon.py --exp-name ${label}_sheldon01_landmark02 --num-sheldons 2 --sheldon-ids 0 1 --sheldon-targets 0 2  --load-dir policies/${label}/policy --restore --benchmark --save-replay --deterministic $*
python sheldon.py --exp-name ${label}_sheldon01_landmark01 --num-sheldons 2 --sheldon-ids 0 1 --sheldon-targets 0 1  --load-dir policies/${label}/policy --restore --benchmark --save-replay --deterministic $*
