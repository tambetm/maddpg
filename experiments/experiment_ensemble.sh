...
#python ensemble.py --exp-name ${label}_eval --load-dir policies/${label}/policy --restore --benchmark --save-replay --deterministic $*
...
#python prepare_ensemble.py benchmark_files/${label}_eval.pkl $*
